...
class _UserRegisterScreenState extends State<UserRegisterScreen> {
  ...
  Future<void> _onSubmit(AppLocalizations l10n) async {
    ...
    try {
      ...
      // If Build4All says the email is already verified, skip OTP and
      // go directly to complete-profile so the user is not stuck.
      ...
      final isAlreadyVerified = (e is AppException &&
          ...
          errLower.contains('already verified');
