...
class EmployeeBloc extends Bloc<EmployeeEvent, EmployeeState> {
  ...
  Future<void> _onLoadEmployees(
    ...
    try {
      ...
      emit(state.copyWith(
        ...
        visibleEmployees: _applySearch(employees, state.searchQuery),
        clearError: true,
      ));
    } catch (e) {
      emit(state.copyWith(loading: false, error: errorMessage(e)));
    }
  }
  ...
  Future<void> _onAddEmployee(
    ...
    try {
      ...
      emit(state.copyWith(actionLoading: false, error: errorMessage(e)));
    }
  }
  ...
  Future<void> _onUpdateEmployee(
    ...
    emit(state.copyWith(actionLoading: true, clearError: true));
    try {
      await updateEmployee(event.id, event.employee);
      final employees = await getEmployees();
      emit(state.copyWith(
        actionLoading: false,
        allEmployees: employees,
  ...
  void _onSearchEmployees(
    ...
    emit(state.copyWith(
      ...
      visibleEmployees: _applySearch(state.allEmployees, event.query),
    ));
  }
