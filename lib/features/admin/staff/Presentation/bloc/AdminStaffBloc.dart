...
Future<void> _onSendStaffRegistrationInvite(
  ...
  void _onSearchStaffUsersLocally(
    SearchStaffUsersLocally event,
    Emitter<AdminStaffState> emit,
  ) {
    emit(
      state.copyWith(
  ...
  Future<void> _onSearchUserForStaffAssignment(
    ...
    try {
      final result = await apiService.searchUserForAssignment(
        email: email,
        roleName: event.roleName,
      );
  ...
  Future<void> _onAssignUserAsStaff(
    AssignUserAsStaff event,
    Emitter<AdminStaffState> emit,
  ) async {
    emit(
      state.copyWith(
  ...
  Future<void> _onRemoveStaffRole(
    RemoveStaffRole event,
    Emitter<AdminStaffState> emit,
  ) async {
    emit(
      state.copyWith(
  ...
  Future<void> _onLoadStaffRoles(
    LoadStaffRoles event,
    Emitter<AdminStaffState> emit,
  ) async {
    emit(
      state.copyWith(
  ...
  void _onClearStaffSearchResult(
    ClearStaffSearchResult event,
    Emitter<AdminStaffState> emit,
  ) {
    emit(
      state.copyWith(
  ...
  void _onClearStaffMessages(
    ClearStaffMessages event,
    Emitter<AdminStaffState> emit,
  ) {
    emit(
      state.copyWith(
  ...
  List<AdminUserModel> _applySearch(
