...
// إذا عندك AnnouncementsPage مستعمل من router، فعّلي هيدا import حسب اسم ملفك:
...
class AppRouter {
  ...
  // ================= ADMIN: ANNOUNCEMENTS =================
  // استعملي هيدي إذا عندك AnnouncementsPage:
  /*
  ...
  */
  ...
  // ================= ADMIN: VIOLATIONS =================
  // ViolationsPage صار يعمل BlocProvider داخله.
  ...
  // ================= PAUSED ADMIN MODULES =================
  static void goToDepartments(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Departments module is paused for now'),
      ),
    );
  }
  ...
  static void goToServices(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Services module is paused for now'),
      ),
    );
  }
  ...
  static void goToEmployees(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Employees module is paused for now'),
      ),
    );
  }
}